const SignUp = ()=>{
    ...
    <div className='container__signup'>
      ...
      <div className='input__wrapper'>
        <input type="email" placeholder='Usuario' className='input__field' required/>
      ...
      <div className='input__wrapper'>
        ...
        <p className='signin__text'>Ya tengo una cuenta <a href="#" className="signin__link">Ingresar</a></p>
      </form>      
    </div>
    )
}
